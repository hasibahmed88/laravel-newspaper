                ...
                <div class="owl-carousel owl-theme slide" id="featured">
                    <div class="item">
                        <article class="featured">
                            ...
                            <figure>
                                <img src="{{ asset('/') }}front/images/news/img04.jpg" alt="Sample Article">
                            </figure>
                            <div class="details">
                    ...
                    <div class="item">
                        <article class="featured">
                            <div class="overlay"></div>
                            <figure>
                                <img src="{{ asset('/') }}front/images/news/img13.jpg" alt="Sample Article">
                            </figure>
                            <div class="details">
                        ...
                        <div class="row">
                            ...
                            <article class="article col-md-12">
                                <div class="inner">
                                    <figure>
                                        <a href="single.html">
                                            <img src="{{ asset('/') }}front/images/news/img06.jpg" alt="Sample Article">
                                        </a>
                                    </figure>
                                    <div class="padding">
                                        <div class="detail">
                        ...
                        <div class="row">
                            ...
                            <article class="article col-md-12">
                                <div class="inner">
                                    <figure>
                                        <a href="single.html">
                                            <img src="{{ asset('/') }}front/images/news/img07.jpg" alt="Sample Article">
                                        </a>
                                    </figure>
                                    <div class="padding">
                                        <div class="detail">
                        ...
                        <div class="body-col vertical-slider" data-max="4" data-nav="#hot-news-nav" data-item="article">
                            <article class="article-mini">
                                <div class="inner">
                                    <figure>
                                        <a href="single.html">
                                            <img src="{{ asset('/') }}front/images/news/img09.jpg" alt="Sample Article">
                                        </a>
                                    </figure>
                                    <div class="padding">
                            ...
                            <article class="article-mini">
                                <div class="inner">
                                    <figure>
                                        <a href="single.html">
                                            <img src="{{ asset('/') }}front/images/news/img08.jpg" alt="Sample Article">
                                        </a>
                                    </figure>
                                    <div class="padding">
